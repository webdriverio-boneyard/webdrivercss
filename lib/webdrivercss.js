...
var viewportScreenshot = require('./viewportScreenshot.js');
var documentScreenshot = require('./documentScreenshot.js');
var generateUUID = require('./generateUUID.js');
var syncImages = require('./syncImages');
...
var WebdriverCSS = function(webdriverInstance, options) {
    ...
    */
    ...
    this.instance.addCommand('webdrivercss', workflow.bind(this), true);

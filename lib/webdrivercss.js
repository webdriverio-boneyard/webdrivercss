...
var run = module.exports.run = function(instance, id, args, cb) {
    ...
    async.waterfall([
        ...
        function(res, done) {
             ...
             */
            if((args.x && args.y && args.width && args.height) || (res.value && res.value.elemBounding)) {

                var cropDim = {
                    x:      typeof args.x !== 'undefined' ? args.x : (res.value.elemBounding.left + (res.value.elemBounding.width  / 2)) || null,
                    y:      typeof args.y !== 'undefined' ? args.y : (res.value.elemBounding.top  + (res.value.elemBounding.height / 2)) || null,
                    width:  typeof args.width  !== 'undefined' ? args.width  : res.value.elemBounding.width  || null,
                    height: typeof args.height !== 'undefined' ? args.height : res.value.elemBounding.height || null
                }

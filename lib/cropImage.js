...
module.exports = function(res, done) {
     ...
     */
        ...
        /**
         * since firefox driver takes screenshots of the whole website (not only viewport)
         * we need to tweak the elemBounding value to crop the image at the right position
         * and prevent screenshot displacements
         * 

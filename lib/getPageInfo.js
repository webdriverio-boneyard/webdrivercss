...
module.exports = function(done) {
    ...
    return Promise.try(function() {
        /*eslint-disable*/
        return that.instance.execute(function() {
            /**
    ...
    .then(function getElementInformation(res) {
        ...
        .then(function (elementInfo) {
            ...
            return [elementInfo, response];
        });
    })
    /**
     * get information about exclude elements
     */
    .then(function getExcludeInfo(res, responses, done) {
        ...
        return that.instance.selectorExecute(excludeElements, function() {

...
module.exports = function(done) {
     ...
     */
    modifyElements(hiddenElements, 'visibility', 'hidden');
    modifyElements(hiddenElements, 'display', 'none');
     ...
     */
    modifyElements(hiddenElements, 'visibility', '');
    modifyElements(hiddenElements, 'display', '');

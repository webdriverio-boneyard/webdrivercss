...
module.exports = function(pagename, args, queuedShots) {
    ...
    queuedShots = typeof queuedShots === 'object' ? queuedShots : JSON.parse(JSON.stringify(args));
    var currentArgs = queuedShots.shift();
